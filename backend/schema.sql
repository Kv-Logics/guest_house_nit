...
CREATE TABLE booking_requests (
    ...
    booking_state VARCHAR(50) DEFAULT 'PENDING_APPROVER' CHECK (booking_state IN ('DRAFT', 'PENDING_APPROVER', 'PENDING_DIRECTOR', 'DIRECTOR_REJECTED', 'APPROVER_APPROVED', 'APPROVER_REJECTED', 'PENDING_ADMIN', 'ADMIN_APPROVED', 'ADMIN_REJECTED', 'READY_FOR_CHECKIN', 'CHECKED_IN', 'CHECKED_OUT', 'NO_SHOW', 'CANCELLED')),
