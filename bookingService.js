        ...
        try {
            ...
            for (const guest of guests) {
                const gRes = await client.query(`
                    ...
                    RETURNING guest_id
                `, [booking_id, guest.guest_name, guest.designation, guest.relation_to_applicant, guest.phone, guest.email, guest.gender, guest.age, guest.address, guest.id_proof_type, guest.id_proof_number, guest.arrival_datetime || arrival_datetime, guest.departure_datetime || departure_datetime]);
